                        ...
                        <div id="menuControleChamadoAdmin" class="menuControleChamado col-xs-12">
                            <nav id="navControleChamadoAdmin" class="navControleChamado">
                                <ul id="ulControleChamadoAdmin" class="ulControleChamado" type="none">
                                    <li id="liAbertoAdmin" class="liControle"><a href="telaAdmin_listaChamadosAbertos.jsp"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;&nbsp;Abertos <div class="quantidadeChamado"><%=abertos%></div></a></li>
                                    <li id="liAndamentoAdmin" class="liControle"><a href="telaAdmin_listaChamadosEmAndamento.jsp"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;&nbsp;Em andamento<div class="quantidadeChamado"><%=emAndamento%></div></a></li>
                                    <li id="liResolvidoAdmin" class="liControle"><a href="telaAdmin_listaChamadosResolvidos.jsp"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;&nbsp;Resolvidos</a><div class="quantidadeChamado"><%=resolvidos%></div></li>
                                    <li id="liCanceladoAdmin" class="liControle"><a href="telaAdmin_listaChamadosCancelados.jsp"><i class="fa fa-times-circle" aria-hidden="true"></i>&nbsp;&nbsp;Cancelados<div class="quantidadeChamado"><%=cancelados%></div></a></li>
                                </ul>
                            </nav>
                            <div id="totalChamadoAdmin" class="margin totalChamado">Total de Chamados: <div class="quantidadeChamado"><%=total%></div></div>
                            <br/><br/>
                            <center>
                                <a id="menuRequisicao" style="display:block;" href="telaAdmin_listaRequisicoes.jsp">Requisição de componentes<div><%=requisicoes%></div></a>
                            </center>
                        </div>
                    </div>
                </div>
