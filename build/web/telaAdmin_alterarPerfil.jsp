                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_perfil.do" method="POST" id="form" class="position form">
                                    ...
                                    Nome:<br/><input type="text" name="nome" id="nomePerfil" maxlength="20" required class="input" value="<%=p.getNome()%>"><br/><br/>
                                    Descrição:<br/><textarea name="descricao" id="descricaoPerfil" maxlength="100" required class="input" ><%=p.getDescricao()%></textarea><br/><br/><br/>  
