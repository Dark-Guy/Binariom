...
<%
    ...
    try {
        ...
        componentes = cDAO.carregarComponentesDoEquipamento(etiqueta);
    } catch (Exception e) {
        out.print("ERRO:" + e);
    }
%>
                ...
                <div id="divControlAdmin" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        <div id="headerSectionAdmin" class="position headerSection">
                            ...
                            <h3 class="position"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Lista de Componentes: <%=etiqueta%></h3>
                        </div>
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                <a class="return" href="telaAdmin_listaEquipamentos.jsp">
                                    <i class="fa fa-reply"></i>&nbsp;&nbsp;Retornar para a lista de equipamentos
                                </a>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="telaAdmin_detalharComponente.jsp?id=<%=c.getId()%>&etiqueta=<%=c.getEquipamento().getEtiqueta()%>" title="Detalhar/Alterar"><i class="fa fa-info" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%
                                        }
                                    %>
                                </table>
                                <a class="btnFinalizarChamado" href="telaAdmin_listaEstoques.jsp" 
                                   style="
                                   display: block;
                                   width: 150px;
                                   padding: 5px;
                                   ...
                                   border-radius: 5px;
                                   color: white;
                                   text-decoration: none;">Ir até o estoque</a>
                            </center>
                        </div>
                    </div>
                </div>
