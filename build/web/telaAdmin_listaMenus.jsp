                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><%= m.getNome()%></td>
                                        <td><%= m.getLink()%></td>
                                        <td><a href="telaAdmin_alterarMenu.jsp?id=<%=m.getId()%>" title="Alterar"><i class="fa fa-pencil" aria-hidden="true"></i></a> ou <a href="#" onclick="excluir(<%=m.getId()%>, '<%=m.getNome()%>')" title="Excluir"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%
                                            }
                                        } catch (Exception e) {
