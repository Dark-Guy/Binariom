    ...
    <head>
        ...
        <script type="text/javascript">
            function excluir(matricula) {
                var url = "gerenciar_usuario.do?op=excluirAdmin&matricula=" + matricula;
                    ...
                    <div class="row">
                        ...
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                ...
                                %>
                                <form method="GET" action="telaAdmin_alterarUsuario.jsp?matricula='<%=us.getMatricula()%>'" >
                                ...
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="telaAdmin_alterarUsuario.jsp?matricula=<%=u.getMatricula()%>" title="Alterar"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                            ou 
