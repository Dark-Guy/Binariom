...
<%
    ...
    chamados = cDAO.carregarChamadosPorMatricula(uAdm.getMatricula());
%>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    %>
                                    <tr>
                                        <td><a href="telaCliente_detalharChamado.jsp?bin=<%=c.getBin()%>"><%=zf.format(c.getBin())%></a></td>
                                        <td><%=c.getStatus()%></td>
                                        <td><%=c.getPrioridade()%></td>
                                        <td><%=df.format(c.getDa())%></td>
                                        <td><%=c.getUsuario().getNome()%></td>
                                        <td><a href="telaCliente_detalharChamado.jsp?bin=<%=c.getBin()%>" title="Detalhar"><i class="fa fa-search" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%
                                            }
                                        } catch (Exception e) {
