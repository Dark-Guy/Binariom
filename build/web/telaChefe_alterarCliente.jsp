...
<%
    ...
    try {
        c.carregarPorMatricula(matricula);
    } catch (Exception e) {
        out.print("ERRO:" + e);
    }
%>
                ...
                <div id="divControlChefe" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        <div id="headerSectionChefe" class="position headerSection">
                            ...
                            <h3 class="position"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Alterar Cliente</h3>
                        </div>
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_cliente.do" method="POST" id="form" class="position form">
                                    ...
                                    Matrícula:<br/><input type="text" name="matricula" id="matCliente" maxlength="5" required class="input" value="<%=c.getMatricula()%>"><br/><br/> 
                                    Nome:<br/><input type="text" name="nome" id="nomeCliente" maxlength="50" required class="input" value="<%=c.getNome()%>"><br/><br/>
                                    CPF:<br/><input type="text" name="cpf" id="cpf" maxlength="11" required class="input" value="<%=c.getCpf()%>"><br/><br/>
                                    Senha:<br/><input type="password" name="senha" id="senhaCliente" maxlength="5" required class="input" value="<%=c.getSenha()%>"><br/><br/>
                                    Setor:<br/><input type="text" name="setor" id="setCliente" maxlength="4" required class="input" value="<%=c.getSetor()%>"><br/><br/>
                                    Sala:<br/><input type="text" name="sala" id="salaCliente" required class="input" value="<%=c.getSala()%>"><br/><br/>
                                    Status: <select name="status" class="form_control" required>
                                    ...
                                    <br>
                                    Telefone:<br/><input type="text" name="telefone" id="telefone" maxlength="11" required class="input" value="<%=c.getTelefone()%>"><br/><br/>
