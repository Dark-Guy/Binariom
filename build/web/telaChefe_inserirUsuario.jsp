                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_usuario.do" method="POST" id="form" class="position form">
                                    ...
                                    Matrícula:<br/><input type="text" name="matricula" id="matUsuario" maxlength="5" required class="input"><br/><br/>
                                    Nome:<br/><input type="text" name="nome" id="nomeUsuario" required class="input"><br/><br/>
                                    CPF:<br/><input type="text" name="cpf" id="cpf" maxlength="11" required class="input"><br/>
                                    Setor:<br/><input type="text" name="setor" id="setorUsuario" maxlength="30" required class="input"><br/>
                                    Telefone:<br/><input type="text" name="telefone" id="telefone" maxlength="30" required class="input"><br/><br/>
                                    Senha:<br/><input type="password" name="senha" id="senhaUsuario" maxlength="5" required class="input"><br/><br/>
                                    Status:
