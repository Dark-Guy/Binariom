                ...
                <div id="divControlAdmin" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        ...
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                <a href="telaChefe_listaChamadosEmAndamento.jsp">
                                ...
                                <a href="telaChefe_listaChamadosCancelados.jsp">
                                    <button class="buttonLista">
                                ...
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="gerenciar_chamado.do?bin=<%=c.getBin()%>&op=realizarChefe&status=emAndamento&usuario_matric+ula=<%=uCh.getMatricula()%>">
                                                <i class="fa fa-forward" title="Realizar"></i>
                                            </a> ou 
                                            <a href="telaChefe_detalharChamado.jsp?bin=<%=zf.format(c.getBin())%>&op=cancelarChefe"> 
