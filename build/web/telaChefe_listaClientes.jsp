    ...
    <head>
        ...
        <script type="text/javascript">
            function excluir(matricula) {
                var url = "gerenciar_cliente.do?op=excluirChefe&matricula=" + matricula;
                    ...
                    <div class="row">
                        ...
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                ...
                                %>
                                <form method="GET" action="telaChefe_alterarCliente.jsp?matricula='<%=cl.getMatricula()%>'" >
                                    <label >Pesquisar Cliente: </label>
                                    <input type="text" name="matricula" class="pesquisarUser">
                                    <input type="submit" name="pesquisar" id="btnPesquisarChamadoCliente" class="btnAbrirChamado margin" value="Pesquisar Cliente">
                                </form>
                                <br/>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><%= c.getTelefone()%></td>
                                        <td><%= c.getStatus()%></td>
                                        <td><a href="telaAdmin_alterarCliente.jsp?matricula=<%=c.getMatricula()%>" title="Alterar"><i class="fa fa-pencil" aria-hidden="true"></i></a> ou <a href="#"  onclick="excluir('<%=c.getMatricula()%>')" title="Excluir"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%
                                            }
                                        } catch (Exception e) {
