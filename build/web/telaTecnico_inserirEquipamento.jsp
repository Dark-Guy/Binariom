                ...
                <div id="divDadosPerfilTecnicoEquipamentoInsert" class="divDadosPerfil col-xs-12 col-md-3 ">
                    <div class="row">
                        ...
                        <div class="dadosPerfil">
                            <div id="nomeTecnicoEquipamentoInsert" class="margin nome"><%=uTec.getNome()%></div>
                            <h4 class="titleMat">Matrícula:</h4>
                            <div id="matriculaTecnicoEquipamentoInsert" class="margin matricula"><%=uTec.getMatricula()%></div>
                ...
                <div id="divTecnicoEquipamentoInsert" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_equipamento.do" method="POST" id="form" class="position form">
                                    <input type="hidden" name="op" value="inserirTecnico">
                                    Etiqueta:<br/><input type="text" name="etiqueta" id="etiquetaEquipamento" maxlength="30" required class="input"><br/><br/> 
                                    Tipo:<br/><input type="text" name="tipo" id="tipoEquipamento" maxlength="50" required class="input"><br/><br/>
