                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_cliente.do" method="POST" id="form" class="position form">
                                    ...
                                    CPF:<br/><input type="text" name="cpf" id="cpf" required class="input" value="<%=c.getCpf()%>"><br/><br/>
                                    ...
                                    <br>
                                    Telefone:<br/><input type="text" name="telefone" id="telefone" required class="input" value="<%=c.getTelefone()%>"><br/><br/>
