                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_menu.do" method="POST" id="form" class="position form">
                                    ...
                                    Nome:<br/><input type="text" name="nome" id="nomeMenu" maxlength="20" required class="input" value="<%=m.getNome()%>"><br/><br/>
                                    Link:<br/><input type="text" name="link" id="linkMenu" maxlength="100" required class="input" value="<%=m.getLink()%>"><br/><br/><br/>  
