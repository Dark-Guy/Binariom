                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_usuario.do" method="POST" id="form" class="position form">
                                    ...
                                    Matrícula:<br/><input type="text" name="matricula" id="matUsuario" required class="input" value="<%=u.getMatricula()%>" readonly><br/>
                                    Nome:<br/><input type="text" name="nome" id="nomeUsuario" required class="input" value="<%=u.getNome()%>"><br/>
                                    CPF:<br/><input type="text" name="cpf" id="cpfUsuario" maxlength="11" required class="input" value="<%=u.getCpf()%>"><br/>
                                    Setor:<br/><input type="text" name="setor" id="setorUsuario" maxlength="4" required class="input" value="<%=u.getSetor()%>"><br/>
                                    Telefone:<br/><input type="text" name="telefone" id="telUsuario" maxlength="8" required class="input" value="<%=u.getTelefone()%>"><br/><br/>
                                    Senha:<br/><input type="password" name="senha" id="senhaUsuario" maxlength="5" required class="input" value="<%=u.getSenha()%>"><br/><br/><br/>
                                    Status:
