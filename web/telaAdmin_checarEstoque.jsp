    ...
    <head>
        ...
        <script type="text/javascript">
            function remover(id, id_estoque, nome) {
                var url = "gerenciar_componente.do?op=removerAdmin&id=" + id + "&id_estoque=" + id_estoque + "&nome=" + nome;
                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><%=c.getMarca()%></td>
                                        <td><%=c.getStatus()%></td>
                                        <td><a href="telaAdmin_detalharComponente.jsp?id=<%=c.getId()%>" title="Detalhar"><i class="fa fa-info" aria-hidden="true"></i></a> ou
                                                <%
                                                    String url = "";
