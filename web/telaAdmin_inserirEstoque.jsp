                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_estoque.do" method="POST" id="form" class="position form">
                                    ...
                                    Nome:<br/><input type="text" name="nome" id="modeloCliente" maxlength="25" required class="input"><br/><br/>
                                    Descricao:<br/><input type="text" name="descricao" id="tipoCliente" maxlength="25" required class="input"><br/><br/>
