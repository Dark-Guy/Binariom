                ...
                <div id="divControlAdmin" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        <div id="headerSectionAdmin" class="position headerSection">
                            ...
                            <h3 class="position"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Inserir Menu</h3>
                        </div>
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_menu.do" method="POST" id="form" class="position form">
                                    <input type="hidden" name="op" value="inserir">
                                    Nome:<br/><input type="text" name="nome" id="nomeMenu" maxlength="20" required class="input"><br/><br/>
                                    Link:<br/><input type="text" name="link" id="linkMenu" maxlength="100" required class="input"><br/><br/><br/>
