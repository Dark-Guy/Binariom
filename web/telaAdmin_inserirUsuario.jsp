                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_usuario.do" method="POST" id="form" class="position form">
                                    ...
                                    Setor:<br/><input type="text" name="setor" id="setorUsuario" maxlength="4" required class="input"><br/>
                                    Telefone:<br/><input type="text" name="telefone" id="telefone" maxlength="8" required class="input"><br/><br/>
