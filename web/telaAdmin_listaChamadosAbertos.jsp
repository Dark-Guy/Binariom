                    ...
                    <div id="divControlAdmin" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                        <div class="row">
                            ...
                            <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                                <center>
                                    <a href="telaAdmin_listaChamadosEmAndamento.jsp">
                                    ...
                                    <table class="tableList table table-responsive">
                                        ...
                                        %>
                                        <tr>
                                            <td><a href="telaAdmin_detalharChamado.jsp?bin=<%=zf.format(c.getBin())%>&cliente=<%=c.getCliente().getMatricula()%>"><%=zf.format(c.getBin())%></a></td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="gerenciar_chamado.do?bin=<%=c.getBin()%>&op=realizarAdmin&status=emAndamento&usuario_matricula=<%=uAdm.getMatricula()%>">
                                                    <i class="fa fa-forward" title="Realizar"></i>
                                                </a> ou 
                                                <a href="telaAdmin_detalharChamado.jsp?bin=<%=zf.format(c.getBin())%>&op=cancelarAdmin"> 
