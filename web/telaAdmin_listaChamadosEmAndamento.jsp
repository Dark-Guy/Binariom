                ...
                <div id="divControlAdmin" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        <div id="headerSectionAdmin" class="position headerSection">
                            ...
                            <h3 class="position"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Lista de Chamados Em Andamento</h3>
                        </div>
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                <a href="telaAdmin_listaChamadosAbertos.jsp">
                                    <button class="buttonLista">
                                        <i class="fa fa-folder-open"></i>&nbsp;&nbsp;Chamados em aberto
                                    </button>
                                </a>
                                <a href="telaAdmin_listaChamadosResolvidos.jsp">
                                    <button class="buttonLista">
                                        <i class="fa fa-check-circle"></i>&nbsp;&nbsp;Chamados resolvidos
                                    </button>
                                </a>
                                <a href="telaAdmin_listaChamadosCancelados.jsp">
                                    <button class="buttonLista">
                                        <i class="fa fa-times-circle"></i>&nbsp;&nbsp;Chamados cancelados
                                    </button>
                                </a>
                                <table class="tableList table table-responsive">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            for (Chamado c : chamado.listarEmAndamento()) {
                                    %>
                                    <tr>
                                        ...
                                        <td><a href="telaAdmin_detalharChamado.jsp?bin=<%=c.getBin()%>&op=finalizarAdmin"><i class="fa fa-check" title="Concluir Chamado"></i></a></td>
                                    </tr>
                                    <%
                                            }
                                        } catch (Exception e) {
