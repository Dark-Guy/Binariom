    ...
    <head>
        ...
        <script type="text/javascript">
            function excluir(etiqueta) {
                var url = "gerenciar_equipamento.do?op=excluirAdmin&etiqueta=" + etiqueta;
                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><%=e.getTipo()%></td>
                                        <td>
                                            <a href="telaAdmin_alterarEquipamento.jsp?etiqueta=<%=e.getEtiqueta()%>" title="Alterar"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                            ou 
                                            <a href="#" onclick="excluir('<%=e.getEtiqueta()%>')" title="Excluir"><i class="fa fa-times" aria-hidden="true"></i></a>
                                            ou
                                            <a href="telaAdmin_listaComponentes.jsp?componente=true&etiqueta=<%=e.getEtiqueta()%>" title="Componentes"><i class="fa fa-microchip" aria-hidden="true"></i></a></td>
