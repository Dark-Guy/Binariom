                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="telaAdmin_checarEstoque.jsp?id=<%=e.getId()%>&nome=<%=e.getNome()%>" title="Checar"><i class="fa fa-eye" aria-hidden="true"></i></a> 
                                            ou
                                            <a href="telaAdmin_requisitarComponente.jsp" title="Requisitar Componente"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <%
                                            }
