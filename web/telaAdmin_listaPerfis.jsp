                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="telaAdmin_alterarPerfil.jsp?id=<%=p.getId()%>" title="Alterar"><i class="fa fa-pencil" aria-hidden="true"></i></a> 
                                            ou 
                                            <a href="#" onclick="excluir(<%=p.getId()%>)" title="Excluir"><i class="fa fa-times" aria-hidden="true"></i></a>
                                            ou
                                            <a href="telaAdmin_menuPerfil.jsp?id=<%=p.getId()%>" title="Menus"><i class="fa fa-bars" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <%
                                            }
