...
<html>
    <head>
        ...
        <title>Requisitar Componente</title>
                                    ...
                                    <li id="li3" class="margin liVisaoGeral li3">
                                        ...
                                        <ul id="ulSubMenu3" class="ulSubMenu ulSubMenu3">
                                            ...
                                            <li id="liSubMenuEstoque2" class="liSubMenu">
                                                <a href="telaAdmin_listaEstoques.jsp"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Lista de Estoques</a>
                                            </li>
                                        </ul>
                                    </li>
                ...
                <div id="divControlAdmin" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        <div id="headerSectionAdmin" class="position headerSection">
                            ...
                            <h3 class="position"><i class="fa fa-folder-open" aria-hidden="true"></i>&nbsp;&nbsp;Requisitar Componente</h3>
                        </div>
                        <div id="divForm2" class="divForm2">
                            <form method="POST" action="gerenciar_chamado.do" id="form2" class="form2 ">
                                ...
                                <input type="hidden" name="cliente_matricula" value="CL000">
                                <input type="hidden" name="usuario_matricula" value="<%=uAdm.getMatricula()%>">
                                <input type="hidden" name="status" value="Requisitado">
                                <input type="hidden" name="op" value="requisitarAdmin">
