                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_equipamento.do" method="POST" id="form" class="position form">
                                    ...
                                    Etiqueta:<br/><input type="text" name="etiqueta" id="etiquetaEquipamento" maxlength="30" required class="input" readonly value="<%=e.getEtiqueta()%>"><br/><br/> 
                                    Tipo:<br/><input type="text" name="tipo" id="tipoEquipamento" maxlength="50" required class="input" value="<%=e.getTipo()%>"><br/><br/>
