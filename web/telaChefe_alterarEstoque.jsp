                        ...
                        <div id="divForm" class="col-xs-12 divForm">
                            <center>
                                <form action="gerenciar_estoque.do" method="POST" id="form" class="position form">
                                    ...
                                    Nome:<br/><input type="text" name="nome" id="nomeEstoque" maxlength="20" required class="input" value="<%=e.getNome()%>"><br/><br/>
                                    Descrição:<br/><input type="text" name="descricao" id="descricaoEstoque" maxlength="100" required class="input" value="<%=e.getDescricao()%>"><br/><br/><br/>  
