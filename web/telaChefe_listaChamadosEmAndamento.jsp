                ...
                <div id="divControlChefe" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        ...
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                <a href="telaChefe_listaChamadosAbertos.jsp">
                                    <button class="buttonLista">
                                        <i class="fa fa-folder-open"></i>&nbsp;&nbsp;Chamados em aberto
                                    </button>
                                </a>
                                <a href="telaChefe_listaChamadosResolvidos.jsp">
                                    <button class="buttonLista">
                                        <i class="fa fa-check-circle"></i>&nbsp;&nbsp;Chamados resolvidos
                                    </button>
                                </a>
                                <a href="telChefe_listaChamadosCancelados.jsp">
                                    <button class="buttonLista">
                                ...
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="telaTecnico_detalharChamado.jsp?bin=<%=c.getBin()%>&op=finalizarChefe"><i class="fa fa-check" title="Concluir Chamado"></i></a></td>
                                    </tr>
                                    </tr>
                                    <%
                                            }
