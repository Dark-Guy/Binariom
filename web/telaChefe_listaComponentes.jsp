                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="telaChefe_detalharComponente.jsp?id=<%=c.getId()%>" title="Detalhar"><i class="fa fa-info" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%
                                        }
                                    %>
                                </table>
                                <a class="btnFinalizarChamado" href="telaChefe_listaEstoques.jsp" 
                                   style="
                                   display: block;
                                   width: 150px;
                                   padding: 5px;
                                   ...
                                   border-radius: 5px;
                                   color: white;
                                   text-decoration: none;">Ir até estoque</a>
                            </center>
                        </div>
                    </div>
                </div>
