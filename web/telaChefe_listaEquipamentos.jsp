    ...
    <head>
        ...
        <script type="text/javascript">
            function excluir(etiqueta) {
                var url = "gerenciar_equipamento.do?op=excluirChefe&etiqueta=" + etiqueta;
                                ...
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ou
                                            <a href="telaChefe_listaComponentes.jsp?etiqueta=<%=e.getEtiqueta()%>" title="listar"><i class="fa fa-microchip" aria-hidden="true"></i></a></td>
