                ...
                <div id="divControlChefe" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        ...
                        <div id="divForm2" class="divForm2">
                            <form method="GET" action="telaChefe_detalharChamado.jsp?bin=<%=c.getBin()%>" id="form2" class="form2">
                                <label id="lblPesquisa" class="labelChamado">Digite o número do chamado:</label><br/>
