                ...
                <div id="divControlTecnico" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        ...
                        <div id="divTableList" class="divTableList col-xs-10 col-xs-offset-1">
                            <center>
                                <a href="telaTecnico_listaChamadosAbertos.jsp">
                                ...
                                <table class="tableList table table-responsive">
                                    ...
                                    %>
                                    <tr>
                                        <td><a href="telaTecnico_detalharChamado.jsp?bin=<%=c.getBin()%>"><%=zf.format(c.getBin())%></a></td>
                                        <td>
                                        ...
                                        <td><a href="telaTecnico_detalharChamado.jsp?bin=<%=c.getBin()%>&op=finalizarTecnico"><i class="fa fa-check" title="Concluir Chamado"></i></a></td>
                                    </tr>
                                    <%
                                            }
                                        } catch (Exception e) {
