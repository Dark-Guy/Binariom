                ...
                <div id="divControlTecnico" class="controleChamado col-xs-12 col-md-9 col-md-offset-3">
                    <div class="row">
                        <div id="headerSectionTecnico" class="position headerSection">
                            ...
                            <h3 class="position"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Lista de Componentes</h3>
                        </div>
                            ...
                            <center>
                                <table class="tableList table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="telaTecnico_detalharComponente.jsp?id=<%=c.getId()%>" title="Detalhar"><i class="fa fa-info" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <%
                                        }
                                    %>
                                </table>
                                <a class="btnFinalizarChamado" href="telaTecnico_listaEstoques.jsp" 
                                   style="
                                   display: block;
                                   width: 150px;
                                   padding: 5px;
