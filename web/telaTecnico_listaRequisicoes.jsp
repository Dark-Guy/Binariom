                    ...
                    <div id="divDadosPerfilTecnico" class="divDadosPerfil col-xs-12 col-md-3 ">
                        <div class="row">
                            ...
                            <div class="dadosPerfil">
                                <div id="nomeTecnico" class="margin nome"><%=uAdm.getNome()%></div>
                                <h4 class="titleMat">Matrícula:</h4>
                                <div id="matriculaTecnico" class="margin matricula"><%=uAdm.getMatricula()%></div>
                                ...
                                <center>
                                    <table class="tableList table table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <i id="iDetalhe" class="fa fa-info detalhe" style="cursor: pointer;" value="" title="" onclick="javascript:window.open('descricao.jspbin=<%=c.getBin()%>&descricao=<%=c.getDescricao()%>', 'popup', 'width=400,height=300')">   
                                                </i>
                                            </td>
                                        </tr>
